...
class AtomSystem extends ParticleSystem {
...
class AtomParticle extends Particle {
	...
	calculateForces(p, dt) {
		...
		this.attractionForce = this.pos.getForceTowardsPoint(mouse, 20, {
			falloff: 0.5,
		});
		// this.v.mult(.99)
