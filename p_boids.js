...
class BoidSystem extends ParticleSystem {
	...
	draw(p) {
		...
		// p.strokeWeight(5)
		this.flockCenter.drawArrow(p, this.flockVelocity, {
			m: 0.5,
			color: [30, 0, 100],
		});
...
class BoidParticle extends Particle {
	...
	calculateForces(p, dt) {
		...
		this.attractionForce = this.pos.getForceTowardsPoint(mouse, 1, {
			falloff: 1.2,
		});
		...
		this.separationForce.mult(0.2);
		this.cohesionForce.mult(0.5);
		this.alignmentForce.mult(0.1);
